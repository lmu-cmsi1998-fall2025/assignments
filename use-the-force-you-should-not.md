**CMSI 1998** Special Studies: Software Carpentry, Fall 2025*
...
Leave any repositories used in the video on the class’s [GitHub organization](https://github.com/lmu-cmsi1998-fall2025). Make sure they are named clearly; at the very least, include your GitHub username in the repository’s name. Ideally, the repository name also identifies that it is part of this episode: `episode-1212`

We expect to see the `practice-1212` and `episode-1212` repositories as well—as before, we will be reviewing them too
